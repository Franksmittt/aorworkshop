...
// --- STORAGE KEYS ---
const PROJECTS_STORAGE_KEY = 'ABSOLUTE_OFFROAD_PROJECTS';
...
const USERS_STORAGE_KEY = 'ABSOLUTE_OFFROAD_USERS';
const TECHNICIANS_STORAGE_KEY = 'ABSOLUTE_OFFROAD_TECHNICIANS';
