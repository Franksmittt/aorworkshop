...
import { Lightbulb, Camera, UserCheck } from 'lucide-react';
...
const AiSuggestions = () => {
    ...
    const suggestions = [
        ...
        {
            id: 'sug-2',
            title: "Photo update on active job",
            description: "Add progress photos to the LC79 build so the team and client can see stripping and fitment milestones.",
            icon: Camera,
